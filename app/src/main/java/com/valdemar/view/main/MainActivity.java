                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    fotoReferencia.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            MensajeEnviar m = new MensajeEnviar("Kevin te ha enviado una foto",downloadUrl.toString(),nombre.getText().toString(),fotoPerfilCadena,"2", ServerValue.TIMESTAMP);
                    ...
                    fotoReferencia.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                           ...
                           // Uri u = taskSnapshot.getDownloadUrl();
                            ...
                            MensajeEnviar m = new MensajeEnviar("Kevin ha actualizado su foto de perfil",downloadUrl.toString(),nombre.getText().toString(),fotoPerfilCadena,"2",ServerValue.TIMESTAMP);
                            databaseReference.push().setValue(m);
                            Glide.with(MainActivity.this).load(downloadUrl.toString()).into(fotoPerfil);
                        }
                    });
